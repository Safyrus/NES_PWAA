...
text = re.sub(r"<bgcolor:513,1,31>", r"<fade_out>", text)
text = re.sub(r"<bgcolor:514,1,31>", r"<fade_out>", text)
text = re.sub(r"<bgcolor:516,1,31>", r"<fade_out>", text)
text = re.sub(r"<bgcolor:260,1,31>", r"<fade_in>", text)
text = re.sub(r"<bgcolor:257,1,31>", r"<fade_in>", text)
text = re.sub(r"<bgcolor:258,1,31>", r"<fade_in>", text)
text = re.sub(r"<bgcolor:257,8,31>", r"<really_quick_fade_in>", text)
text = re.sub(r"<fadetoblack:[^>]*>", r"<fade_out>", text)
