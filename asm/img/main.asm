...
; .byte $00, $00 ; palette 0 indices. (background color)
; .byte $00, $00 ; palette 1 indices. (character primary color)
; .byte $00, $00 ; palette 2 indices. (character contour color)
; .byte $00, $00 ; palette 4 indices. (character secondary color)
