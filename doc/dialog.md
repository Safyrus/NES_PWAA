...
- [Dialog scripting language](#dialog-scripting-language)
  - [Description](#description)
  - [Tag list](#tag-list)
    - [**comments** / `<!-- -->`](#comments-------)
    - [**b** (break)](#b-break)
    - [**p** (page)](#p-page)
    - [**fp** (force page)](#fp-force-page)
    - [**speed**](#speed)
    - [**wait**](#wait)
    - [**const**](#const)
    - [**name**](#name)
    ...
    - [**return**](#return)
    - [**event**](#event)
      - [NES-PWAA event char](#nes-pwaa-event-char)
        - [EVT\_CR](#evt_cr)
        - [EVT\_CR\_OBJ](#evt_cr_obj)
        - [EVT\_CR\_SET](#evt_cr_set)
        - [EVT\_CR\_CLR](#evt_cr_clr)
        - [EVT\_CR\_IDX](#evt_cr_idx)
    - [**ext**](#ext)
